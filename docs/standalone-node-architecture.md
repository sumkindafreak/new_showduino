...
- S3 Lamp Node `0.3.4` — same GRANT machine; standalone carbide lamp + local WebUI; V1 Fermion four-file library; physical GPIOs confirmed. Historical C3 Lamp Node remains reference-only.
