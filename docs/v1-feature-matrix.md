...
| Firmware compile | Director 0.9.2 | Comms 0.4.0 | P4 0.6.0 | Embedded WebUI (regenerated this pass) | n/a | Audio 0.4.2, Lamp 0.3.3, Pixel 0.1.0 | **YES** after this compile pass |
