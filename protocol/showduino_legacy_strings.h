...
#define SHOWDUINO_LEGACY_DIRECTOR_LOCATE                 "DIRECTOR:LOCATE"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REQUEST         "EMERGENCY:CLEAR_REQUEST"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_CONFIRM         "EMERGENCY:CLEAR_CONFIRM"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_CANCEL          "EMERGENCY:CLEAR_CANCEL"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_EXPIRED         "EMERGENCY:CLEAR_EXPIRED"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_OK              "EMERGENCY:CLEAR:OK"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_PREFIX "EMERGENCY:CLEAR:REJECTED:"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_NO_REQUEST \
  "EMERGENCY:CLEAR:REJECTED:NO_REQUEST"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_BUTTON \
  "EMERGENCY:CLEAR:REJECTED:BUTTON_ACTIVE"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_TIMEOUT \
  "EMERGENCY:CLEAR:REJECTED:TIMEOUT"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_NOT_LATCHED \
  "EMERGENCY:CLEAR:REJECTED:NOT_LATCHED"
#define SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REJECTED_SUPERSEDED \
  "EMERGENCY:CLEAR:REJECTED:SUPERSEDED"
...
#define SHOWDUINO_LEGACY_ROUTE_LAMP       "ROUTE:LAMP:"
#define SHOWDUINO_LEGACY_ROUTE_EMERGENCY  "ROUTE:EMERGENCY:"
...
#define SHOWDUINO_LEGACY_NODETYPE_LAMP      "LAMP"
#define SHOWDUINO_LEGACY_NODETYPE_EMERGENCY "EMERGENCY"
...
#define SHOWDUINO_LEGACY_AUDIO_NODE_LOOP        "AUDIO:NODE:LOOP"
#define SHOWDUINO_LEGACY_AUDIO_NODE_PAUSE       "AUDIO:NODE:PAUSE"
#define SHOWDUINO_LEGACY_AUDIO_NODE_RESUME      "AUDIO:NODE:RESUME"
...
static inline ShowduinoMessageType showduino_legacy_map_command(const char *cmd) {
  ...
  if (strcmp(cmd, SHOWDUINO_LEGACY_EMERGENCY_CLEAR) == 0 ||
      strcmp(cmd, SHOWDUINO_LEGACY_EMERGENCY_CLEAR_CONFIRM) == 0) {
    return SHOWDUINO_MSG_EMERGENCY_CLEAR_REQUEST;
  }
  if (strcmp(cmd, SHOWDUINO_LEGACY_EMERGENCY_CLEAR_REQUEST) == 0) {
    return SHOWDUINO_MSG_EMERGENCY_CLEAR_PENDING;
  }
  if (strcmp(cmd, SHOWDUINO_LEGACY_EMERGENCY_CLEAR_CANCEL) == 0) {
    return SHOWDUINO_MSG_EMERGENCY_CLEAR_CANCEL;
  }
  if (strcmp(cmd, SHOWDUINO_LEGACY_DIRECTOR_LOCATE) == 0) {
    return SHOWDUINO_MSG_DIRECTOR_LOCATE;
  }
